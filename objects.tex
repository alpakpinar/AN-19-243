...
\begin{figure}[htbp]
  \centering
        \includegraphics[width=0.45\textwidth]{fig/ak4_eta1_puidcomparison.png}
...
\begin{figure}[htbp]
  \centering
        \includegraphics[width=0.45\textwidth]{fig/placeholder.png}
...
%The selection of events with the resulting value of $< 0.5$ is adopted in this analysis.
