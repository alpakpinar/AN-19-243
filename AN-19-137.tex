...
%%%%%%%%%%%%%%%  Title page %%%%%%%%%%%%%%%%%%%%%%%%
\cmsNoteHeader{AN-19-137} % This is over-written in the CMS environment: useful as preprint no. for export versions
...
\title{Search for VBF Higgs bosons decaying to invisible particles at sqrt(s) = 13 TeV with 2017 data}
...
\abstract{
    This note describes the search for invisible decays of Higgs bosons produced via vector boson fusion (VBF), using a shape-based analysis. The analysis described in this note is performed using data collected in 2017 by CMS at sqrt(s) = 13 TeV and corresponds to an integrated luminosity of 41.5 fb^{-1}. The results are interpreted in terms of the invisible branching fraction of the 125 GeV Higgs boson.}
% >> PDF Metadata
