...
\begin{table*}[htb]
    \topcaption{Summary of the common selection requirements for mono-$\PV$ and monojet categories.}
    \begin{center}
...
\begin{table}[htb]
    \topcaption{Summary of the selection requirements for the mono-$\PV$ category.
        Events that fail the mono-$\PV$ selection are assigned to the monojet category.}
    \begin{center}
        \renewcommand{\arraystretch}{1}
        \ifthenelse{\boolean{cms@external}}{\footnotesize}{}
        {
            \begin{scotch}{l c}
